"""Wolf RPG saves: unlock and read the values inside them.

``core.engines.wolf`` holds the obfuscation primitives. This module — like
the other decryptors here — is what the save editor uses to open a file and
reach the editable values.
