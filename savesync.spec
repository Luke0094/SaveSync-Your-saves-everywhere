...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'core.save_editor.save_hold',
        'core.engines', 'core.engines.game_engine',
        'core.engines.alicesoft', 'core.engines.artemis', 'core.save_editor.es3',
        'core.save_editor.game_keys', 'core.engines.gvas', 'core.engines.kirikiri',
        'core.engines.lcf', 'core.engines.lzstring', 'core.engines.qsp',
        'core.engines.rags', 'core.engines.renpy_save',
        'core.engines.rubymarshal', 'core.engines.sol', 'core.engines.tyrano',
        'core.save_editor.unityfs', 'core.save_editor.unreal_crypt',
        'core.engines.wolf', 'core.save_editor.wolf_save',
